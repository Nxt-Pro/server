...
export class FixCareerTimelineEntity1769325817035 implements MigrationInterface {
  name = 'FixCareerTimelineEntity1769325817035';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "career_timeline" ("id" character varying(26) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "player_id" character varying(26) NOT NULL, "title" character varying NOT NULL, "start_date" date NOT NULL, "end_date" date, "description" text, "is_current" boolean NOT NULL DEFAULT false, "evidence_url" character varying, CONSTRAINT "PK_b2fb83c80143c32295903deb6bf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
