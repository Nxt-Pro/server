...
export class AddAchievements1769270073169 implements MigrationInterface {
  name = 'AddAchievements1769270073169';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "achievements" ADD CONSTRAINT "FK_85b2af1dca4083a7b5d0fff977c" FOREIGN KEY ("player_id") REFERENCES "player_profiles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
