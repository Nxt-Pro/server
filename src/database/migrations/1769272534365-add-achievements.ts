...
export class AddAchievements1769272534365 implements MigrationInterface {
  name = 'AddAchievements1769272534365';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "career_timeline" ("player_id" character(26) NOT NULL, "title" character varying NOT NULL, "start_date" date NOT NULL, "end_date" date, "description" text, "is_current" boolean NOT NULL DEFAULT false, "evidence_url" character varying, "player_id_user_id" character varying(26), CONSTRAINT "PK_d8974fd576cc6eb46bc6e289ada" PRIMARY KEY ("player_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "player_stats" ("player_id" character(26) NOT NULL, "goals" integer NOT NULL, "assists" integer NOT NULL, "season_year" integer NOT NULL, "matches_played" integer NOT NULL DEFAULT '0', "yellow_cards" integer NOT NULL DEFAULT '0', "red_cards" integer NOT NULL DEFAULT '0', "clean_sheets" integer NOT NULL DEFAULT '0', "avg_rating" numeric(3,2), "player_id_user_id" character varying(26), CONSTRAINT "PK_93f34075933141f2cadabb03eaf" PRIMARY KEY ("player_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0edcc25b9644a695a09630cd19" ON "player_stats" ("avg_rating") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_93f34075933141f2cadabb03ea" ON "player_stats" ("player_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "career_timeline" ADD CONSTRAINT "FK_eaea6a93859288b1f9e35c217db" FOREIGN KEY ("player_id_user_id") REFERENCES "player_profiles"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_stats" ADD CONSTRAINT "FK_409f38c72847beff34f6e340c59" FOREIGN KEY ("player_id_user_id") REFERENCES "player_profiles"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "player_stats" DROP CONSTRAINT "FK_409f38c72847beff34f6e340c59"`,
    );
    await queryRunner.query(
      `ALTER TABLE "career_timeline" DROP CONSTRAINT "FK_eaea6a93859288b1f9e35c217db"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_93f34075933141f2cadabb03ea"`,
    );
    await queryRunner.query(
